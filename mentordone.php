		...
		<div class="row">
			...
			<div class="col span_9 col_last">
				...
				<ul class="sf-menu">	
						...
						<li id="menu-item-5922" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-5922"><a href="logoutmentor.php">SignOut</a></li>
					</ul>
		...
		<div class="vc_column-inner">
			<div class="wpb_wrapper">	
				<div class="wpb_text_column wpb_content_element " >
					<div class="wpb_wrapper">
						<h1>#M&M</h1>
						<h5>Welcome Mentor <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b>.</h5>
					</div>
				</div>
...
<div align="center">
	<button type="button" class="collapsible"><h6>Check Marks</h6></button>
	<div class="content">
	<form id="checkmarks" method="post" action="checkmarks.php">
	...
	<br>
	<button type="button" class="collapsible"><h6>Check Attendence</h6></button>
	<div class="content">
	<form id="checkmarks" method="post" action="checkattendence.php">
			<div class="form-group">
                    <label for="roll_no">Roll No: </label>
					<br>
                <input id="roll_no" style="width:350px;"class="form-control" type="text" name="roll_no"/>
	...
	<br>
	<button type="button" class="collapsible"><h6>Check Concern</h6></button>
	<div class="content">
	<form id="checkmarks" method="post" action="checkconcern.php">
			<div class="form-group">
                    <label for="roll_no">Roll No: </label>
					<br>
                <input id="roll_no" style="width:350px;"class="form-control" type="text" name="roll_no"/>
