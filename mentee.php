...
if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true){
    header("location: menteedone.php");
    exit;
}
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["email"]))){
		...
		header("location: credsmentee.php");
    } else{
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){                    
					...
					$nirmit = password_hash("nirmit", PASSWORD_DEFAULT);
					$rajkumar = password_hash("rajkumar",PASSWORD_DEFAULT);
					$aditi = password_hash("aditi", PASSWORD_DEFAULT);
                    if(mysqli_stmt_fetch($stmt)){
                        if(password_verify($password,$nirmit)||password_verify($password,$rajkumar)||password_verify($password,$aditi)){
							...
							header("location: wrongpmentee.php");
					...
					header("location: invalidmentee.php");
                }
            } else{
...
<head>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=0" /><title>M&M &#8211; A SIESGST Mentee-Login Page</title>
		...
		<div class="vc_column-inner">
			<div class="wpb_wrapper">	
				<div class="wpb_text_column wpb_content_element " >
					<div class="wpb_wrapper">
						<h1>#M&M</h1>
						<h5>SIESGST Mentee-Login Page</h5>
					</div>
				</div>
	...
	<form method="post" action="mentee.php">
            <div class="form-group">
				<div class="col-xs-3">
					...
					<br>
                <input id="email" style="width:350px;"class="form-control" type="email" name="email"/>
				</div>
            </div>
            <br>
            <div class="form-group">
