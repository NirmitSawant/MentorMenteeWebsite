...
$sql = "SELECT * FROM attendence where rollno='$roll_no'";
	...
	<div class="container">
		<div class="row">
			...
			<div class="col span_9 col_last">
				...
				<nav>
					<ul class="sf-menu">	
						<li id="menu-item-5923" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-5923"><a href="mentordone.php">Go Back</a></li>
		...
		<div class="vc_column-inner">
			<div class="wpb_wrapper">	
				<div class="wpb_text_column wpb_content_element " >
					<div class="wpb_wrapper">
						<h1>#M&M</h1>
						<h5>Attendence of <b><?php echo htmlspecialchars($_POST['roll_no']); ?></b></h5>
					</div>
				</div>
				<a class="nectar-button large see-through-2  has-icon"  style=""  href="#checkout" data-color-override="false" data-hover-color-override="false" data-hover-text-color-override="#ffffff"><span>CheckOut</span><i style="font-size:28px" class="fa">&#xf0a9;</i></a>
			</div>
		</div>
	</div> 
</div>
