	...
	<div class="container">
		<div class="row">
			...
			<div class="col span_9 col_last">
				...
				<nav>
					<ul class="sf-menu">	
						<li id="menu-item-5923" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-5923"><a href="">Profile</a></li>
						<li id="menu-item-5922" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-5922"><a href="logoutmentee.php">SignOut</a></li>
					</ul>
		...
		<div class="vc_column-inner">
			<div class="wpb_wrapper">	
				<div class="wpb_text_column wpb_content_element " >
					<div class="wpb_wrapper">
						<h1>#M&M</h1>
						<h5>Welcome Mentee <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b>.</h5>
					</div>
				</div>
				<a class="nectar-button large see-through-2  has-icon"  style=""  href="#explore" data-color-override="false" data-hover-color-override="false" data-hover-text-color-override="#ffffff"><span>Get Started</span><i style="font-size:28px" class="fa">&#xf0a9;</i></a>
			</div>
		</div>
	</div> 
</div>
...
<div align="center">
	<button type="button" class="collapsible"><h6>Enter your Marks</h6></button>
	<div class="content">
	<form id="marks" method="post" action="marks.php">
		<div class="form-group">
                    <label for="roll_no">Roll No: </label>
					<br>
                <input id="roll_no" style="width:350px;"class="form-control" type="text" name="roll_no"/>
            </div>
            <br>
            <div class="form-group">
                    <label for="subject">Subject: </label>
                    <br>
                    <input name="subject" id="subject" style="width:350px;" class="form-control" type="text"/>
            </div>
			<br>
			<div class="form-group">
                    <label for="marks">Marks: </label>
                    <br>
                    <input name="marks" id="marks" style="width:350px;" class="form-control" type="text"/>
            </div>
			<br>
            <input type="submit" name="submitm" value="submit" id="btn" class="btn btn-primary">
    </form>
	</div>
	<br>
	<button type="button" class="collapsible"><h6>Enter your Attendence</h6></button>
	<div class="content">
	<form id="attendence" method="post" action="attendence.php">
	...
	<div class="form-group">
			...
			<br>
			<div class="form-group">
                    <label for="attendence">Attendence(in Percentage): </label>
                    <br>
                    <input name="attendence" id="attendence" style="width:350px;" class="form-control" type="text"/>
            </div>
			<br>
            <input type="submit" name="submita" value="submit" id="btn" class="btn btn-primary">
	
			</form>
	</div>
	<br>
	<button type="button" class="collapsible"><h6>Contact your mentor</h6></button>
	<div class="content">
	<form id="concern" method="post" action="concern.php">
			<div class="form-group">
                    <label for="roll_no">Roll No: </label>
					<br>
                <input id="roll_no" style="width:350px;"class="form-control" type="text" name="roll_no"/>
			...
			<br>
        <input type="submit" name="submitc" value="submit" id="btn" class="btn btn-primary">
	</form>
	</div>
	<br><br><br><br>
</div>
